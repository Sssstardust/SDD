...
def build_onboarding_commands(attachment_file: Path) -> list[list[str]]:
    ...
    return [
        [sys.executable, str(ROOT / "sdd_core" / "application" / "generators" / "refresh_module_map.py"), "--attachment-file", str(attachment_file)],
        [sys.executable, str(ROOT / "sdd_core" / "application" / "generators" / "refresh_schema_context.py"), "--attachment-file", str(attachment_file)],
        [sys.executable, str(ROOT / "sdd_core" / "application" / "generators" / "refresh_baseline_governance.py"), "--baseline-dir", str(baseline_dir)],
        [sys.executable, str(ROOT / "sdd_core" / "application" / "generators" / "refresh_project_state.py")],
        [sys.executable, str(ROOT / "sdd_core" / "application" / "generators" / "build_project_console.py"), "--output-dir", str(artifacts_dir)],
    ]
