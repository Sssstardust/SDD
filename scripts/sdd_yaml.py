...
If PyYAML is available, these helpers delegate to it. The built-in fallback
supports the subset used by feature-brief.md and release-plan.md: nested
mappings, lists, quoted scalars, booleans and numbers.
"""
