...
| 实体 | 说明 | 对应表/对象 | 备注 |
| --- | --- | --- | --- |
| ToB | ToB 相关领域对象 | t_tob_pricing_item | 来自 schema-context |
| 审批 | 审批 相关领域对象 | t_tob_pricing_plan | 来自 schema-context |
| 通知 | 通知 相关领域对象 | t_tob_pricing_item | 来自 schema-context |
| 消息 | 消息 相关领域对象 | t_tob_pricing_item | 来自 schema-context |
